...
MountSpy_Achievements = {
    {id = 614, name = "For the Alliance!"}, {id = 619, name = "For the Horde!"},
    {id = 2136, name = "Glory of the Hero"}, {id = 2138, name = "Glory of the Raider (25 Player)"},
    {id = 2143, name = "Leading the Cavalry"},
    {id = 2144, name = "What A Long, Strange Trip It's Been"},
    {id = 2536, name = "Mountain o' Mounts"}, {id = 2537, name = "Mountain o' Mounts"},
    {id = 4079, name = "A Tribute to Immortality"}, {id = 4156, name = "A Tribute to Immortality"},
    ...
    {id = 6827, name = "Pandaren Ambassador"}, {id = 6828, name = "Pandaren Ambassador"},
    ...
    {id = 8124, name = "Glory of the Thundering Raider"}, {id = 8302, name = "Mount Parade"},
    ...
    {id = 9396, name = "Glory of the Draenor Hero"}, {id = 9496, name = "Warlord's Deathwheel"},
    {id = 9598, name = "Mountacular"}, {id = 9669, name = "Guild Glory of the Draenor Raider"},
    {id = 9705, name = "Advanced Husbandry"}, {id = 9706, name = "The Stable Master"},
    {id = 9713, name = "Awake the Drakes"}, {id = 9909, name = "Heirloom Hoarder"},
    {id = 10018, name = "Draenor Pathfinder"}, {id = 10149, name = "Glory of the Hellfire Raider"},
    {id = 10356, name = "Lord of the Reins"}, {id = 11066, name = "Underbelly Tycoon"},
    {id = 11163, name = "Glory of the Legion Hero"}, {id = 11176, name = "Remember to Share"},
    {id = 11180, name = "Glory of the Legion Raider"},
    {id = 11987, name = "Glory of the Argus Raider"}, {id = 12103, name = "...And Chew Mana Buns"},
    {id = 12401, name = "Glory of the Ulduar Raider"},
    {id = 12806, name = "Glory of the Uldir Raider"},
    {id = 12812, name = "Glory of the Wartorn Hero"},
    {id = 12866, name = "100 Exalted Reputations"}, {id = 12931, name = "No Stable Big Enough"},
    ...
    {id = 13517, name = "Two Sides to Every Tale"}, {id = 13541, name = "Mecha-Done"},
    {id = 13638, name = "Undersea Usurper"}, {id = 13687, name = "Glory of the Eternal Raider"},
    ...
    {id = 14353, name = "Ardenweald's a Stage"}, {id = 14355, name = "Glory of the Nathria Raider"},
    {id = 14532, name = "Shadowlands Keystone Master: Season One"},
    {id = 14570, name = "Twisting Corridors: Layer 8"}, {id = 15035, name = "On the Offensive"},
    ...
    {id = 15254, name = "The Jailer's Gauntlet: Layer 4"}, {id = 15310, name = "A Tour of Towers"},
    {id = 15322, name = "Flawless Master (Layer 16)"}, {id = 15336, name = "From A to Zereth"},
...
MountSpy.HelpData = {
    ...
    {command = "auto", description = "Toggles whether to show mount info automatically when you click on a player character."}
};
